...
function cookieBanner_init(){let alreadyAcceptingCookies=localStorage.getItem(cookieBanner_acceptCookieId);if(alreadyAcceptingCookies!="true"){setTimeout(()=>cookieBanner_show(),1000);}}
